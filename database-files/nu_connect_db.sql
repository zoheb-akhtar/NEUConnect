...
insert into anaylst (name, email, department) values ('Reuben Newall', 'rnewall0@shop-pro.jp', 'Business Intelligence');
insert into anaylst (name, email, department) values ('Augustine Beyn', 'abeyn1@parallels.com', 'Student Success Analytics');
insert into anaylst (name, email, department) values ('Flory Cud', 'fcud2@columbia.edu', 'Business Intelligence');
insert into anaylst (name, email, department) values ('Sascha Payfoot', 'spayfoot3@chicagotribune.com', 'Marketing Analytics');
insert into anaylst (name, email, department) values ('Farleigh Fausset', 'ffausset4@phpbb.com', 'Platform Analytics');
insert into anaylst (name, email, department) values ('Sephira Tennewell', 'stennewell5@hao123.com', 'Student Success Analytics');
insert into anaylst (name, email, department) values ('Baxie Iacobo', 'biacobo6@sogou.com', 'Data Analytics');
insert into anaylst (name, email, department) values ('Israel Culter', 'iculter7@imgur.com', 'Risk & Compliance Analytics');
insert into anaylst (name, email, department) values ('Benedick Rumble', 'brumble8@typepad.com', 'Operations Analytics');
insert into anaylst (name, email, department) values ('Sloane Shottin', 'sshottin9@odnoklassniki.ru', 'Insights Analytics');
insert into anaylst (name, email, department) values ('Sonnnie Koppelmann', 'skoppelmanna@amazonaws.com', 'Data Analytics');
insert into anaylst (name, email, department) values ('Marris Legrice', 'mlegriceb@army.mil', 'Product Analytics');
insert into anaylst (name, email, department) values ('Audie Ciccoloi', 'aciccoloic@over-blog.com', 'Risk & Compliance Analytics');
insert into anaylst (name, email, department) values ('Sascha Shotbolt', 'sshotboltd@shareasale.com', 'Student Success Analytics');
insert into anaylst (name, email, department) values ('Emelita Beesey', 'ebeeseye@ycombinator.com', 'Operations Analytics');
insert into anaylst (name, email, department) values ('Hilde Klaesson', 'hklaessonf@blinklist.com', 'Operations Analytics');
insert into anaylst (name, email, department) values ('Yolanda Duggon', 'yduggong@google.ru', 'Data Analytics');
insert into anaylst (name, email, department) values ('Clair Oneile', 'coneileh@histats.com', 'Platform Analytics');
insert into anaylst (name, email, department) values ('Ronna Pasmore', 'rpasmorei@digg.com', 'Product Analytics');
insert into anaylst (name, email, department) values ('Leroi Alcock', 'lalcockj@independent.co.uk', 'Operations Analytics');
insert into anaylst (name, email, department) values ('West Rennock', 'wrennockk@accuweather.com', 'Business Intelligence');
insert into anaylst (name, email, department) values ('Jocelyne Trenear', 'jtrenearl@google.pl', 'Risk & Compliance Analytics');
insert into anaylst (name, email, department) values ('Gibby Grand', 'ggrandm@elegantthemes.com', 'Platform Analytics');
insert into anaylst (name, email, department) values ('Claresta Falkner', 'cfalknern@youtube.com', 'Insights Analytics');
insert into anaylst (name, email, department) values ('Allissa Oertzen', 'aoertzeno@domainmarket.com', 'Business Intelligence');
insert into anaylst (name, email, department) values ('Trevor Bannister', 'tbannisterp@wikimedia.org', 'Risk & Compliance Analytics');
insert into anaylst (name, email, department) values ('Sharai Martinello', 'smartinelloq@bbc.co.uk', 'Operations Analytics');
insert into anaylst (name, email, department) values ('Marlane Craighall', 'mcraighallr@home.pl', 'Operations Analytics');
insert into anaylst (name, email, department) values ('Kelley McIlmorow', 'kmcilmorows@cloudflare.com', 'Alumni Engagement Analytics');
insert into anaylst (name, email, department) values ('Kara Crapper', 'kcrappert@sciencedirect.com', 'Data Analytics');

-- Sample data for student
insert into student (name, email, major_id, location_id, graduation_year, profile_summary, created_at) values ('Kahlil Erdely', 'kerdely0@oaic.gov.au', 24, 13, 2028, 'Thinking about switching majors and want to talk to someone who made a similar transition.', '2025/02/27');
insert into student (name, email, major_id, location_id, graduation_year, profile_summary, created_at) values ('Jessee Van Castele', 'jvan1@yelp.com', 2, 26, 2028, 'Looking for guidance on networking with alumni and using LinkedIn effectively.', '2024/11/26');
...
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Leah Kinchin', 'lkinchin0@ucsd.edu', 2020, 'Actuary', 32, 'Gaming', 'I enjoy mentoring students who are exploring careers in tech and product and I’m happy to review resumes and projects.', 9, 'busy', '2023-10-25');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Brendon Habbin', 'bhabbin1@spiegel.de', 2020, 'VP Marketing', 28, 'Consulting', 'I transitioned careers after graduation and like helping students who feel unsure about their current major or path.', 8, 'available', '2023-04-10');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Isa Cranke', 'icranke2@soup.io', 2022, 'Quality Engineer', 10, 'Automotive', 'communication', 22, 'inactive', '2024-12-29');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Clarisse Rennels', 'crennels3@weibo.com', 2014, 'Biostatistician III', 10, 'Media & Entertainment', 'I like helping students translate class projects', 11, 'inactive', '2025-07-12');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Ashlan Cornill', 'acornill4@delicious.com', 2020, 'Junior Executive', 5, 'Cybersecurity', 'I’m in healthcare/biotech and enjoy mentoring students who are curious about mission-driven and impact-focused work.', 19, 'inactive', '2025-02-23');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Luce Gilfillan', 'lgilfillan5@businesswire.com', 2016, 'Health Coach IV', 17, 'Cybersecurity', 'I went to grad school after NU and can talk about whether it’s worth it and how to plan for it.', 15, 'available', '2025-02-02');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Emmy Basile', 'ebasile6@people.com.cn', 2022, 'Office Assistant I', 24, 'E-commerce', 'I transitioned careers after graduation and like helping students who feel unsure about their current major or path.', 12, 'busy', '2023-01-31');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Cosmo Leif', 'cleif7@cyberchimps.com', 2009, 'VP Quality Control', 13, 'Government', 'and early career growth strategy.', 15, 'inactive', '2025-11-29');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Judy Anning', 'janning8@jigsy.com', 2015, 'Marketing Assistant', 3, 'Biotech', 'I work in finance and can share insight into recruiting timelines', 9, 'inactive', '2023-04-20');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Byram Dornin', 'bdornin9@nps.gov', 2011, 'Administrative Officer', 4, 'Marketing', 'I went to grad school after NU and can talk about whether it’s worth it and how to plan for it.', 21, 'inactive', '2024-05-19');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Davina Pounsett', 'dpounsetta@yellowpages.com', 2021, 'Research Assistant III', 21, 'Energy', 'and storytelling for interviews.', 30, 'inactive', '2023-02-18');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Philomena Gellately', 'pgellatelyb@noaa.gov', 2011, 'Editor', 13, 'Education', 'I focus on product and UX and can help with portfolios', 10, 'busy', '2023-08-23');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Gregory Elder', 'gelderc@example.com', 2008, 'Staff Scientist', 17, 'Data & Analytics', 'I transitioned careers after graduation and like helping students who feel unsure about their current major or path.', 13, 'available', '2025-08-21');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Salli Drage', 'sdraged@omniture.com', 2007, 'Paralegal', 20, 'Cybersecurity', 'and part-time jobs into strong resume bullet points.', 2, 'busy', '2024-01-08');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Lacy Stuer', 'lstuere@sbwire.com', 2022, 'Structural Engineer', 28, 'Automotive', 'I focus on product and UX and can help with portfolios', 30, 'available', '2024-11-12');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Antonetta Maydwell', 'amaydwellf@about.com', 2022, 'Administrative Officer', 23, 'Media & Entertainment', 'Python', 29, 'busy', '2024-02-17');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Ingeborg Whittaker', 'iwhittakerg@sun.com', 2020, 'Staff Accountant III', 15, 'Healthcare', 'I’ve worked at both startups and big companies and can share honest pros and cons of each path.', 15, 'busy', '2023-06-25');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Masha Dobrovolny', 'mdobrovolnyh@un.org', 2015, 'Account Executive', 17, 'Nonprofit', 'I focus on product and UX and can help with portfolios', 23, 'busy', '2023-09-22');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Farleigh Brittles', 'fbrittlesi@cyberchimps.com', 2006, 'Payment Adjustment Coordinator', 3, 'Human Resources', 'I enjoy mentoring students who are exploring careers in tech and product and I’m happy to review resumes and projects.', 19, 'busy', '2025-01-22');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Carlita Goodread', 'cgoodreadj@issuu.com', 2008, 'Software Engineer I', 10, 'Marketing', 'I transitioned careers after graduation and like helping students who feel unsure about their current major or path.', 28, 'inactive', '2025-02-24');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Emmerich Severy', 'eseveryk@360.cn', 2021, 'Budget/Accounting Analyst II', 17, 'Government', 'Python', 5, 'available', '2024-08-09');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Rickie Stansfield', 'rstansfieldl@nih.gov', 2020, 'Analog Circuit Design manager', 33, 'Transportation & Logistics', 'I love talking about how to network effectively and build genuine relationships with people in your industry.', 2, 'available', '2024-08-05');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Carlin Vida', 'cvidam@mediafire.com', 2021, 'Web Designer I', 14, 'Automotive', 'I work in data and analytics and enjoy helping students with SQL', 14, 'available', '2023-06-19');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Alphard MacCaull', 'amaccaulln@gizmodo.com', 2006, 'Librarian', 16, 'Human Resources', 'I went to grad school after NU and can talk about whether it’s worth it and how to plan for it.', 9, 'busy', '2024-03-16');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Adelbert Borell', 'aborello@abc.net.au', 2020, 'Financial Advisor', 3, 'Healthcare', 'I’m passionate about supporting first-generation and underrepresented students as they navigate internships and early careers.', 18, 'inactive', '2025-11-05');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Hadria Senecaux', 'hsenecauxp@purevolume.com', 2013, 'Marketing Assistant', 28, 'Manufacturing', 'I’ve worked at both startups and big companies and can share honest pros and cons of each path.', 11, 'inactive', '2025-02-10');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Lolita Fonso', 'lfonsoq@wordpress.com', 2005, 'Help Desk Technician', 5, 'Education', 'I’m passionate about supporting first-generation and underrepresented students as they navigate internships and early careers.', 29, 'inactive', '2024-05-14');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Cris O''Callaghan', 'cocallaghanr@nba.com', 2020, 'Assistant Media Planner', 2, 'Healthcare', 'case studies', 9, 'busy', '2023-08-26');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Shantee Leipnik', 'sleipniks@infoseek.co.jp', 2019, 'Research Assistant III', 24, 'Media & Entertainment', 'I focus on product and UX and can help with portfolios', 30, 'inactive', '2025-01-23');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Jobi Fairn', 'jfairnt@goo.ne.jp', 2007, 'Community Outreach Specialist', 28, 'Real Estate', 'technical prep', 4, 'busy', '2024-05-23');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Kristoforo Stratford', 'kstratfordu@blogspot.com', 2005, 'Environmental Specialist', 19, 'Government', 'and how to talk about their projects.', 15, 'available', '2025-07-07');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Phelia Kilduff', 'pkilduffv@hibu.com', 2015, 'Chemical Engineer', 24, 'Government', 'I’m in healthcare/biotech and enjoy mentoring students who are curious about mission-driven and impact-focused work.', 25, 'available', '2025-02-05');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Benedick Queen', 'bqueenw@technorati.com', 2009, 'Associate Professor', 21, 'Transportation & Logistics', 'I enjoy doing mock interviews and helping students feel more confident going into technical or behavioral rounds.', 16, 'available', '2024-04-24');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Dehlia MacFie', 'dmacfiex@virginia.edu', 2018, 'Office Assistant I', 19, 'Biotech', 'and how to stand out as a candidate.', 16, 'available', '2023-06-17');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Chiquita Gaskoin', 'cgaskoiny@goodreads.com', 2008, 'Recruiting Manager', 15, 'Biotech', 'and part-time jobs into strong resume bullet points.', 16, 'busy', '2025-10-12');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Merci Given', 'mgivenz@time.com', 2005, 'Product Engineer', 5, 'Legal Services', 'I love talking about how to network effectively and build genuine relationships with people in your industry.', 2, 'available', '2024-10-24');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Ailene Glaister', 'aglaister10@mashable.com', 2014, 'Chief Design Engineer', 2, 'Nonprofit', 'I transitioned careers after graduation and like helping students who feel unsure about their current major or path.', 29, 'available', '2024-12-09');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Everett Jeschner', 'ejeschner11@networkadvertising.org', 2014, 'Structural Analysis Engineer', 12, 'Marketing', 'I focus on product and UX and can help with portfolios', 29, 'available', '2025-03-23');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Patricia Hrinchishin', 'phrinchishin12@unesco.org', 2022, 'Chief Design Engineer', 27, 'E-commerce', 'and storytelling for interviews.', 11, 'available', '2024-07-09');
insert into alumni (name, email, graduation_year, current_role, company_id, field, bio, location_id, availibity_status, created_at) values ('Bernetta Wolfarth', 'bwolfarth13@google.pl', 2012, 'Account Executive', 4, 'Media & Entertainment', 'and how to talk about their projects.', 21, 'available', '2023-01-26');
